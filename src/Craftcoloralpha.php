...
namespace devkai\craftcoloralpha;

use devkai\craftcoloralpha\fields\Coloralpha as ColoralphaField;
 ...
 *
 */
class Craftcoloralpha extends Plugin
{
    // Static Properties
    // =========================================================================
    ...
    public function init()
    {
        ...
        Event::on(
            ...
            function (RegisterComponentTypesEvent $event) {
                $event->types[] = ColoralphaField::class;
            }
        );
