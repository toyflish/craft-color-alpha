...
namespace devkai\craftcoloralpha\fields;

use devkai\craftcoloralpha\Craftcoloralpha;
use devkai\craftcoloralpha\assetbundles\coloralphafield\ColoralphaFieldAsset;
 ...
 * @since     0.1
 */
class Coloralpha extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('craft-color-alpha', 'Color-Alpha');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'craft-color-alpha/_components/fields/Coloralpha_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(ColoralphaFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').CraftcoloralphaColoralpha(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'craft-color-alpha/_components/fields/Coloralpha_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
